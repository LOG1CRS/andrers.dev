...
export const about = {
  eyebrow: "About",
  title: "I'm a technologist who enjoys turning ideas into products people actually use.",
  body: [
    "My interest in programming started with something simple: I wanted to make my own ideas real. Learning to build gave me a way to experiment, create from scratch, and eventually use technology to solve problems that could genuinely help other people. Over time, that curiosity grew beyond software into data, cloud architecture, product design, and technical leadership, taking me from building individual applications to shaping enterprise products and data platforms used across complex organizations.",
    "What continues to inspire me is understanding how people work, where they struggle, and how technology can make their jobs easier, their decisions better, or their processes simpler. That perspective is also shaping where I want to go next: growing into product and technology leadership, creating useful digital products that solve meaningful problems, help people, and move businesses forward, while staying close to the technical foundation that made me want to build in the first place.",
  ],
  facts: [
    {
      label: "Current role",
    ...
    {
      label: "Current scope",
      value: ["Technical direction of digital products and data platforms"],
    },
  ...
  items: [
    {
      ...
      body: [
        "I turn data into a foundation for action, connecting information across systems and making it reliable enough to power analytics, workflows, and automation. The real value comes when data stops being something people only look at and starts helping them",
        "make better decisions, simplify work, and move processes forward.",
      ],
    },
    {
      index: "02",
      ...
      body: [
        "I start by understanding the people, processes, and business behind a problem before deciding what is worth building. The goal is not to ship more features, but to create products that solve the right problem, make sense for the people using them,",
        "and work technically and strategically.",
      ],
    },
    {
      index: "03",
      ...
      body: [
        "A product matters when it changes something for the better. I care about adoption, better decisions, simpler processes, and meaningful outcomes for the people using what I build. Impact is what connects the technology we create to the reason we decided to",
  ...
  roles: [
    {
      ...
      bullets: [
        'Architected and delivered the [[Manufacturing Data Warehouse]] on BigQuery in 8 months, centralizing production and quality data from all [[14]] plants under unified business rules, and built the products on top of it: "[[Red Neuronal]]," the official monthly metric central directors use to evaluate every plant, "[[Metrix]]," a suite of Power BI KPI dashboards that replaced manual reporting for [[300]] area analysts, and "[[DMX]]," a progressive web app for project and activity tracking used by [[1,000+]] employees.',
      ],
    },
    {
      date: "2022 – 2023",
